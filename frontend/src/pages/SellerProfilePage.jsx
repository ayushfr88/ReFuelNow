...
import { User, Mail, Phone, Shield, ArrowLeft, X, Lock, LogOut } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-neutral-50 relative">
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <Link to="/seller-dashboard" className="inline-flex items-center text-neutral-500 hover:text-primary mb-8 transition-colors">
                    <ArrowLeft size={20} className="mr-2" /> Back to Dashboard
                </Link>

                <div className="bg-white rounded-3xl border border-neutral-200 shadow-sm overflow-hidden">
                    <div className="h-48 bg-gradient-to-r from-green-500/10 to-green-600/10 relative">
                        <div className="absolute -bottom-16 left-8 sm:left-12">
                            <div className="w-32 h-32 rounded-full bg-white p-2 shadow-lg relative group">
                                <div className="w-full h-full rounded-full bg-neutral-100 flex items-center justify-center text-green-600 text-4xl font-bold border-2 border-green-100 overflow-hidden">
                                    {user.profilePicture ? (
                                            ...
                                            {isEditingPhone ? (
                                                <div className="flex-1 flex gap-2">
                                                    <input
                                                        ...
                                                        className="flex-1 bg-white border border-neutral-200 rounded px-2 py-1 text-sm focus:outline-none focus:border-green-500"
                                ...
                                <>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-3 bg-neutral-50 border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                        />
                                    </div>
                                    <div>
